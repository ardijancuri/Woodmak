	...
	<div class="ws-container ws-footer__top">
		<section class="ws-footer__brand" aria-label="<?php esc_attr_e( 'Footer brand', 'woodmak-store' ); ?>">
			...
			<div class="ws-footer__social" aria-label="<?php esc_attr_e( 'Social links', 'woodmak-store' ); ?>">
				<a class="ws-footer__social-link" href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr__( 'Instagram', 'woodmak-store' ); ?>">
				...
				<a class="ws-footer__social-link" href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr__( 'Facebook', 'woodmak-store' ); ?>">
					<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
		...
		<div class="ws-footer__links">
			...
			<section class="ws-footer__column">
				...
				<ul>
					<li><a href="tel:+389158400757">+48 15 840 07 57</a></li>
					<li><a href="mailto:info@woodmak.local">info@woodmak.local</a></li>
